        ...
        <div class="footer">
            ...
            <div class="medio">
                <div class="Inicio">
                    <ul>
                        <li>
                            <router-link to="/home" class="footer-link">Inicio</router-link>
                        </li>
                        <li>
                            <!-- <router-link to="/ayuda">Ayuda</router-link> -->
                        </li>
                        <li>
                            <!-- <router-link to="/sobre-nostros">Sobre Nosotros</router-link> -->
                        </li>
                    </ul>
                </div>
              <div>
            ...
            <div class="derecha">
                <p class="footer-contact">Contacto: <strong>+09-12-2018</strong></p>
                <p>© 2021 EcoEats</p>
            </div>
        </div>
    </div>
...
<style>
    ...
    .footer-icons li {
      margin: 0 20px; /* Ajusta el espacio entre los íconos */
    }
